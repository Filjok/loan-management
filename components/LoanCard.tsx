...
const LoanCard: React.FC<LoanCardProps> = ({ loan, onClick }) => {
  ...
  return (
    <div 
      ...
      className={`bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-all cursor-pointer group relative overflow-hidden`}
    >
      {isCompleted && (
      ...
      <div className="flex justify-between items-start mb-4">
        <div>
          ...
          <div className="flex items-center text-gray-500 text-sm mt-1">
            ...
            <span>ID: {loan.borrower.idProof}</span>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 gap-4 text-sm border-t border-gray-100 pt-4">
        ...
        <div>
           ...
           <p className="font-medium text-gray-700">{loan.interestRate}% / mo</p>
        </div>
        <div>
